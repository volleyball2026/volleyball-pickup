...
with tab1:
    ...
    # [핵심 1] 게임이 없거나 'CLOSED' 상태면 대기 화면 표시
    if not current_game or current_game.get('제목') == 'CLOSED':
        ...
        # [핵심 2] 신청자가 없어도 기본 틀(현황판)은 보여주도록 수정
        st.divider()
        ...
        if applicants:
            ...
            with col_list:
                ...
                # 비고란에 세트 정보, 제외 포지션 정보 등을 표시하고 싶다면 여기서 처리
